...
<header id="header">
		...
		<section>
			...
			<nav class="hor-menu main-menu fitst-pad-none">
	...
	<!-- 		<div class="test-flex">
			...
			<section>
				...
				<section>
					...
					<form>
						...
						<input class="btn btn-text btn-default" type="submit"
							value="검색" />
					</form>
				</section>
		...
		<!-- ------------------------------------------------------------------------------------ -->		
				...
				<a href="reg" class="button warning-button">테스트</a>
				</div>
				<div>
				이전1다음
				</div>
	...
	<footer id="footer">
		<div class="root-container">
			<!-- 회사정보 주소서울특별시 마포구 토정로35길 11, 5층 266호(용강동,
		인우빌딩)관리자메일admin@newlecture.com사업자 등록번호132-18-46763 통신 판매업 신고제
		...
		Right Reserved. Contact admin@newlecture.com for more information  -->
		</div>
	</footer>
</body>
</html>
