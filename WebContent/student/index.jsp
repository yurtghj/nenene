		...
		<div class="content-container clearfix">
			...
			<aside class="aside">
				...
				<nav class="menu text-menu first margin-top">
					<h1>온라인 강의실</h1>
					<ul>
						<li><a class="current" href="/student/index">수강생 홈</a></li>						
				...
				<nav class="menu text-menu">
					...
					<ul>
						...
						<li><a  class="" href="community/answeris/list.jsp">내 오류노트</a></li>
	...
	<div class="-list- vertical margin-top first padding-bottom">
		...
		<div>
			...
			<div class="-padding- -border- bottom b-green -text- center underline">
				<a href="../customer/event/1" class="-symbol-">[편하게 읽는 자바 프로그래밍] 도서 구매 이벤트</a>
			</div>
		...
		<div class="align-center margin-top">
			...
			<span style="display:inline-block; background:url('..student/test03/20171008_083951.jpg') no-repeat center; background-size:cover ;vertical-align:middle; width: 120px;height: 120px;border: 1px solid #595959; border-radius:60px; box-shadow: 0 4px 15px 0 rgba(0, 0, 0, 0.15);"></span>			
